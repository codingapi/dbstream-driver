...
public class StatementProxy implements Statement {
    ...
    public StatementProxy(ConnectionProxy connection, Statement statement, DBMetaData metaData) {
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        SQLExecuteState executeState = new SQLExecuteState(sql, connection, statement, this.metaData);
        SQLExecuteListenerContext.getInstance().before(executeState);
        ResultSet resultSet = statement.executeQuery(sql);
        SQLExecuteListenerContext.getInstance().after(executeState, resultSet);
        return resultSet;
    }
    ...
    public int executeUpdate(String sql) throws SQLException {
        ...
        SQLExecuteListenerContext.getInstance().after(executeState, result);
        return result;
    }
