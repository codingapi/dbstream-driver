...
public class StatementProxy implements Statement {
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        SQLRunningState runningState = new SQLRunningState(sql, connection, statement, this.metaData);
        SQLRunningContext.getInstance().before(runningState);
        ResultSet resultSet = statement.executeQuery(sql);
        SQLRunningContext.getInstance().after(runningState, resultSet);
        return resultSet;
    }
    ...
    public int executeUpdate(String sql) throws SQLException {
        ...
        SQLRunningContext.getInstance().after(runningState, result);
        return result;
    }
